...
class PostApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [PostDTOListingResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PostDTOListingResponse>> postsFuzzyGet({ 
    String? userId,
    int? startIndex = 0,
    int? count,
    String? tags,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (searchTitle != null) r'searchTitle': encodeQueryParameter(_serializers, searchTitle, const FullType(String)),
      if (postType != null) r'postType': encodeQueryParameter(_serializers, postType, const FullType(int)),
      if (lostItemState != null) r'lostItemState': encodeQueryParameter(_serializers, lostItemState, const FullType(int)),
    };
    ...
    PostDTOListingResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PostDTOListingResponse),
      ) as PostDTOListingResponse;
    ...
    return Response<PostDTOListingResponse>(
      data: _responseData,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> postsIdDelete({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PostDetailsDTO>> postsIdGet({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PostDetailsDTO),
      ) as PostDetailsDTO;
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> postsIdPut({ 
    required String id,
    ...
    try {
      ...
      _bodyData = updatePostDTO == null ? null : _serializers.serialize(updatePostDTO, specifiedType: _type);
  ...
  Future<Response<Post>> postsPost({ 
    ...
    try {
      ...
      _bodyData = createPostDTO == null ? null : _serializers.serialize(createPostDTO, specifiedType: _type);
