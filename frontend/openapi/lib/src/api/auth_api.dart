...
class AuthApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [AuthorizeDTO] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthorizeDTO>> apiAuthAuthorizePost({ 
    ...
    final _path = r'/api/Auth/authorize';
    ...
    try {
      const _type = FullType(AuthorizeRequest);
      _bodyData = authorizeRequest == null ? null : _serializers.serialize(authorizeRequest, specifiedType: _type);
    ...
    AuthorizeDTO? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AuthorizeDTO),
      ) as AuthorizeDTO;
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserDTO>> apiAuthIdGet({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/Auth/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> apiAuthIdPut({ 
    required String id,
  ...
  /// Returns a [Future] containing a [Response] with a [AuthorizeDTO] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthorizeDTO>> apiAuthRefreshPost({ 
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<User>> apiAuthRegisterPost({ 
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> apiAuthRevokePost({ 
    String? userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<Message>>> messagesReceiverUserIdSenderUserIdGet({ 
    ...
    final _path = r'/messages/{receiverUserId}/{senderUserId}'.replaceAll('{' r'receiverUserId' '}', encodeQueryParameter(_serializers, receiverUserId, const FullType(String)).toString()).replaceAll('{' r'senderUserId' '}', encodeQueryParameter(_serializers, senderUserId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<ChatDTO>>> userchatsIdGet({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/userchats/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
